            ...
            <div id="carouselExampleAutoplaying" class="carousel slide border " data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets/img/inicio1.jpg" class="d-block w-100 rounded-3" >
                    </div>
                    <div class="carousel-item">
                        <img src="assets/img/inicio2.jpg" class="d-block w-100 rounded-3" >
                    </div>
                    <div class="carousel-item">
                        <img src="assets/img/inicio3.jpg" class="d-block w-100 rounded-3" >
                    </div>
                </div>
